...
// 1. Use inheritance by having a separate class for each kind of activity with a base class to contain any shared attributes or behaviors. (so four classes total)
...
//notes from group meeting.  //Activities class base class = shared stuff: animation, timer, displaying the starting and ending message which can be stored in each separate class?  
//Video
class Program
{
